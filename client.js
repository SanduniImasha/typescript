...
function displayUsersAsHtml() {
    return __awaiter(this, void 0, void 0, function () {
        var userListDiv, users, userList_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    userListDiv = document.getElementById('userList');
                    if (!userListDiv) return [3 /*break*/, 2];
                    return [4 /*yield*/, (0, memberService_1.getUsersFromJsonFile)()];
                case 1:
                    users = _a.sent();
                    userList_1 = document.createElement('ul');
                    // Iterate over the users and create list items for each
                    users.forEach(function (user) {
                        var listItem = document.createElement('li');
                        listItem.textContent = user.name;
                        userList_1.appendChild(listItem);
                    });
                    // Append the list to the user list div
                    userListDiv.appendChild(userList_1);
                    return [3 /*break*/, 3];
                case 2:
